# Step 2. 이미지 최적화 — srcset + CDN 리사이징으로 용량 97% 감소

## 목차
1. [렌더링 전략 — CSR → SSR → Streaming](./step1.md)
2. **이미지 최적화 — srcset + CDN 리사이징** ← 현재 문서
...
> 📎 [예제 페이지](https://monorepo-playground-examples.vercel.app/rendering/infinite-scroll) · [PR #7](https://github.com/developer-choi/monorepo-playground/pull/7)
