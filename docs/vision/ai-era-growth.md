...
자세한 구현은 [Sentry 구축 PR](https://github.com/developer-choi/monorepo-playground/pull/12)을 참고해 주시면 감사하겠습니다.
...
19개 이상의 커스텀 린트 룰을 적용했습니다 — [정적 분석 PR](https://github.com/developer-choi/monorepo-playground/pull/11)
